...
interface SolicitarAdmisionProps {
  titulo: boolean;
}
...
function SolicitarAdmision({ titulo }: SolicitarAdmisionProps) {
  ...
  return (
    <>
      ...
      <div className="container d-flex flex-column pt-3 pb-3 justify-content-center pb-5 mb-5 ">
        {titulo && (
          <h2 className="display-7 fw-bold py-4">Formulario de Solicitud de Admisión</h2>
        )}
        ...
        <form className="container">
          <div className="row">
            <div className="col-12 col-md-6">
              <div className="mb-3">
                <label htmlFor="nombreEstudiante" className="form-label fw-bold">
          ...
          <div className="row">
            ...
            <div className="col-12 col-md-6">
              <div className="mb-3">
                <label htmlFor="direccionEstudiante" className="form-label fw-bold">
          ...
          <div className="row">
            <div className="col-12 col-md-6">
              <div className="mb-3">
                <label htmlFor="grado" className="form-label fw-bold">
                  Grado
                </label>
                <select
                  className="form-select"
            ...
            <div className="col-12 col-md-6">
              <div className="mb-3">
                <label htmlFor="escuelaActual" className="form-label fw-bold">
                  Escuela actual
                </label>
                <input
                  type="text"
          ...
          <div className="row">
            <div className="col">
              <div className="mb-3">
                <label htmlFor="nombrePadreTutor" className="form-label fw-bold">
            ...
            <div className="col-12 col-md-6">
              <div className="mb-3">
                <label htmlFor="relacionEstudiante" className="form-label fw-bold">
          ...
          <div className="row">
            <div className="col-12 col-md-6">
              <div className="mb-3">
                <label htmlFor="direccionPadreTutor" className="form-label fw-bold">
            ...
            <div className="col-12 col-md-6">
              <div className="mb-3">
                <label htmlFor="numeroTelefono" className="form-label fw-bold">
                  Número de teléfono
                </label>
                <input
                  type="tel"
          ...
          <div className="row">
            <div className="col-12 col-md-6">
              <div className="mb-3">
                <label htmlFor="correoElectronico" className="form-label fw-bold">
                  Correo electrónico
                </label>
                <input
                  type="email"
          ...
          <div className="row">
            <div className="mb-3">
              <label htmlFor="notasComentarios" className="form-label fw-bold">
                Notas o comentarios
              </label>
              <input
                type="text"
